...
const MIGRATION_QUERIES = [
  ...
  `ALTER TABLE links ADD COLUMN IF NOT EXISTS password_salt VARCHAR(64);`,
  `ALTER TABLE links ADD COLUMN IF NOT EXISTS is_one_time BOOLEAN NOT NULL DEFAULT FALSE;`,
  `ALTER TABLE links ADD COLUMN IF NOT EXISTS is_consumed BOOLEAN NOT NULL DEFAULT FALSE;`,
  `ALTER TABLE links ADD COLUMN IF NOT EXISTS consumed_at TIMESTAMPTZ;`,
